...
const defaultCardClassName: string =
  "relative px-3 py-2 w-full max-w-2xl bg-background-light dark:bg-background-dark rounded-xl shadow-2xl border border-slate-200 dark:border-slate-800 overflow-hidden";
