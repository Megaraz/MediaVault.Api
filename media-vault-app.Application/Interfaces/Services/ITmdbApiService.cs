...
namespace media_vault_app.Application.Interfaces.Services
{
    public interface ITmdbApiService
    {
        ...
        Task<Result<IReadOnlyList<MediaEntrySearchResultDto>>> SearchAsync(string search, MediaType mediaType, int page = 1, int pageSize = 10, string? ordering = null, CancellationToken cancellationToken = default);
    }
}
